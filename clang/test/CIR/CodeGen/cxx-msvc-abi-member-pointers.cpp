// RUN: %clang_cc1 -triple x86_64-pc-windows-msvc -std=c++17 -fclangir -fno-clangir-call-conv-lowering -emit-cir -mmlir -mlir-print-ir-before=cir-cxxabi-lowering %s -o %t.cir 2> %t-before.cir
